...
y <- c(0.755, 0.073, 0.011, 0.006, 0.002, 0.003, 0.008, 0.001, 0.001, 0.07, 0.05, 0.02)
...
# Calculate the pseudo critical pressure of the gas
Ppc <- calculate_Ppc_ahmed_method(gamma_g, y[10], y[11], y[12])  

# Calculate the pseudo critical temperature of the gas
